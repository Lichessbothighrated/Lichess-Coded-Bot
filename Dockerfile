...
RUN wget --no-check-certificate "https://abrok.eu/stockfish/builds/c4a1390f4e485b8b6a2cf43504a968a3c8a4317d/linux64modern/stockfish_21110813_x64_modern.zip" -O chess-engine.zip
RUN wget --no-check-certificate "https://tests.stockfishchess.org/api/nn/nn-6762d36ad265.nnue" -O nn-938525872610.nnue
